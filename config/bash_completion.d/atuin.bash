_atuin() {
    ...
    do
        case "${cmd},${i}" in
            ...
            atuin__account__help,help)
                ...
                ;;
            atuin__account__help,link)
                cmd="atuin__account__help__link"
                ;;
            ...
            atuin__ai,init)
                ...
                ;;
            atuin__ai,inline)
                cmd="atuin__ai__inline"
                ;;
            atuin__ai__help,help)
                cmd="atuin__ai__help__help"
                ;;
            atuin__ai__help,init)
                cmd="atuin__ai__help__init"
                ;;
            atuin__ai__help,inline)
                cmd="atuin__ai__help__inline"
                ;;
            atuin__daemon,help)
                cmd="atuin__daemon__help"
                ;;
            atuin__daemon,restart)
                cmd="atuin__daemon__restart"
                ;;
            atuin__daemon,start)
                cmd="atuin__daemon__start"
                ;;
            atuin__daemon,status)
                cmd="atuin__daemon__status"
                ;;
            atuin__daemon,stop)
                cmd="atuin__daemon__stop"
                ;;
            atuin__daemon__help,help)
                cmd="atuin__daemon__help__help"
                ;;
            atuin__daemon__help,restart)
                cmd="atuin__daemon__help__restart"
                ;;
            atuin__daemon__help,start)
                cmd="atuin__daemon__help__start"
                ;;
            atuin__daemon__help,status)
                cmd="atuin__daemon__help__status"
                ;;
            atuin__daemon__help,stop)
                cmd="atuin__daemon__help__stop"
                ;;
            ...
            atuin__help__account,delete)
                ...
                ;;
            atuin__help__account,link)
                cmd="atuin__help__account__link"
                ;;
            ...
            atuin__help__account,register)
                ...
                ;;
            atuin__help__ai,init)
                cmd="atuin__help__ai__init"
                ;;
            atuin__help__ai,inline)
                cmd="atuin__help__ai__inline"
                ;;
            atuin__help__daemon,restart)
                cmd="atuin__help__daemon__restart"
                ;;
            atuin__help__daemon,start)
                cmd="atuin__help__daemon__start"
                ;;
            atuin__help__daemon,status)
                cmd="atuin__help__daemon__status"
                ;;
            atuin__help__daemon,stop)
                cmd="atuin__help__daemon__stop"
                ;;
            ...
            atuin__help__dotfiles__var,set)
                ...
                ;;
            atuin__help__hex,init)
                cmd="atuin__help__hex__init"
                ;;
            ...
            atuin__help__store,verify)
                ...
                ;;
            atuin__hex,help)
                cmd="atuin__hex__help"
                ;;
            atuin__hex,init)
                cmd="atuin__hex__init"
                ;;
            atuin__hex__help,help)
                cmd="atuin__hex__help__help"
                ;;
            atuin__hex__help,init)
                cmd="atuin__hex__help__init"
                ;;
    ...
    case "${cmd}" in
        atuin)
            opts="-h -V --help --version setup history import stats search sync login logout register key status account kv store dotfiles scripts init info doctor wrapped daemon default-config ai hex uuid contributors gen-completions help"
        ...
        atuin__ai__init)
            ...
            ;;
        atuin__ai__inline)
            opts="-v -h --verbose --api-endpoint --api-token --keep --hook --debug-state --help [COMMAND]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__gen__completions)
            ...
            ;;
        atuin__help)
            opts="setup history import stats search sync login logout register key status account kv store dotfiles scripts init info doctor wrapped daemon default-config ai hex uuid contributors gen-completions help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__scripts__run)
            ...
            ;;
        atuin__search)
            opts="-c -e -b -i -r -f -h --cwd --exclude-cwd --exit --exclude-exit --before --after --limit --offset --interactive --filter-mode --search-mode --shell-up-key-binding --keymap-mode --human --cmd-only --print0 --delete --delete-it-all --reverse --tz --timezone --format --inline-height --include-duplicates --result-file --help [QUERY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
